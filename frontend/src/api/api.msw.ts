...
export const getApiReviewsListMock = () => ([...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({id: faker.datatype.number(), created_at: faker.random.word(), updated_at: faker.random.word(), title: faker.random.word(), description: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined]), status: faker.random.word(), user: faker.datatype.number(), listing: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined])})))

export const getApiReviewsCreateMock = () => ({id: faker.datatype.number(), created_at: faker.random.word(), updated_at: faker.random.word(), title: faker.random.word(), description: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined]), status: faker.random.word(), user: faker.datatype.number(), listing: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined])})

export const getApiReviewsRetrieveMock = () => ({id: faker.datatype.number(), created_at: faker.random.word(), updated_at: faker.random.word(), title: faker.random.word(), description: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined]), status: faker.random.word(), user: faker.datatype.number(), listing: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined])})

export const getApiReviewsPartialUpdateMock = () => ({id: faker.datatype.number(), created_at: faker.random.word(), updated_at: faker.random.word(), title: faker.random.word(), description: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined]), status: faker.random.word(), user: faker.datatype.number(), listing: faker.random.arrayElement([faker.random.arrayElement([faker.random.word(), null]), undefined])})
...
export const getApiUsersListMock = () => ([...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({username: faker.random.word(), name: faker.random.arrayElement([faker.random.word(), undefined]), url: faker.random.word()})))

export const getApiUsersRetrieveMock = () => ({username: faker.random.word(), name: faker.random.arrayElement([faker.random.word(), undefined]), url: faker.random.word()})

export const getApiUsersUpdateMock = () => ({username: faker.random.word(), name: faker.random.arrayElement([faker.random.word(), undefined]), url: faker.random.word()})

export const getApiUsersPartialUpdateMock = () => ({username: faker.random.word(), name: faker.random.arrayElement([faker.random.word(), undefined]), url: faker.random.word()})

export const getApiUsersMeRetrieveMock = () => ({username: faker.random.word(), name: faker.random.arrayElement([faker.random.word(), undefined]), url: faker.random.word()})
